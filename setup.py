...
setup(
    ...
    url='https://github.com/narrativewolf/Instagram-datadownload',
    download_url='https://github.com/narrativewolf/Instagram-datadownload/tarball/1.6.1',
